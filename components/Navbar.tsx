...
const Navbar = () => {
    ...
    //useUser coming from clerk to fetch user details
    const {user} = useUser();
  return (
            ...
            <nav className="w-fit flex gap-7.5 items-center">
                {
                    navItems.map(({label, href}) => {
                        ...
                        return (
                            <Link href={href} key={label} className={cn('nav-link-base', isActive ? 'nav-link-active' : 'text-black opacity-70')}>
                                {
                                    label
                                }
                            </Link>
                ...
                <SignedOut>
                    ...
                    <SignUpButton mode="modal">
                        <button className="nav-link-base">Sign Up</button>
                    </SignUpButton>
                </SignedOut>
                <SignedIn>
